...
export default function Home() {
  return (
    <main>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              ...
              >
                View My Games <FaArrowRight className="text-sm" />
              </Link>
              <Link
                href="/games/new"
                className="inline-flex items-center justify-center gap-2 text-base px-8 py-3 rounded-lg font-medium bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 transition-all duration-200"
              >
                <FaPlus className="text-sm" /> Add New Game
              </Link>
            </div>
          </div>
        </div>
      ...
      {/* Features */}
      <div className="py-16 bg-surface-light dark:bg-surface-dark">
